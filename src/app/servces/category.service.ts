...
export class CategoryService {
  private urlPostCat:   string = 'http://localhost:8282/category/storeCategory';
  private urlGetAllCat: string = 'http://localhost:8282/category/findCategory';
  private urlGetOneCat: string = 'http://localhost:8282/product/storeProduct';
